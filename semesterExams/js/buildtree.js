...
function buildTree(dname)
{
	...
	fetch("http://localhost:5502/xml/regular.xml")
       .then(response =>  { 
...
// This version works, but AP Classroom links do not work.
...
// This version current does not work, in Chrome it causes a memory link
function generateContentUnit(unit)
{
	for (u=0;u<unit.length;u++)
	{
